                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (_selectedType == -1 && selectedNode == i)
                    {
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            if (selectedTool == 0) { var fmh_97_88_638277074367208508 = Quaternion.identity; back = Handles.FreeMoveHandle(back, capSize * 2, snap, Handles.RectangleHandleCap); }
                    ...
                    if (_selectedType == 1 && selectedNode == i)
                    {
                        ...
                        {
                            Handles.color = capSelectedColor;
                            if (selectedTool == 0) { var fmh_121_94_638277074367250802 = Quaternion.identity; forward = Handles.FreeMoveHandle(forward, capSize * 2, snap, Handles.RectangleHandleCap); }
                    ...
                    if (_selectedType == 0 && selectedNode == i)
                    {
                        ...
                        {
                            Handles.color = capSelectedColor;
                            if (selectedTool == 0) { var fmh_144_92_638277074367258339 = Quaternion.identity; middle = Handles.FreeMoveHandle(middle, capSize * 2, snap, Handles.RectangleHandleCap); }
