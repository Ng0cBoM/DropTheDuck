                ...
                if (_showTension)
                {
                    for (int i = 0; i < path.segmentCount; i++)
                    {
                        ...
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            var fmh_82_67_638277074367786663 = Quaternion.identity; point = Handles.FreeMoveHandle(point, capSize, snap, Handles.CircleHandleCap);
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (selectedNode == i)
                    {
                        using (var scope = ChangeCheckScope.New(path))
                        {
                            ...
                            if (selectedTool == 0) { var fmh_118_96_638277074367794132 = Quaternion.identity; position = Handles.FreeMoveHandle(position, capSize * 2, snap, Handles.RectangleHandleCap); }
